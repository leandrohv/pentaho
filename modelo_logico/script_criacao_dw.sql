...
ALTER TABLE Dim_Organizacional COMMENT 'Tabela Dimensão Organizacional';
...
ALTER TABLE Dim_Categoria COMMENT 'Tabela Dimensão Categoria';
...
ALTER TABLE Dim_Marca COMMENT 'Tabela Dimensão da Marca';
...
ALTER TABLE Dim_Produto COMMENT 'Tabela Dimensão de Produto';
...
ALTER TABLE Dim_Tempo COMMENT 'Tabela Dimensão de Tempo';
...
CREATE TABLE Fato_002 (
                ...
                PRIMARY KEY (Cod_Cliente, Cod_Produto, Cod_Fabrica, Cod_Tempo)
);

ALTER TABLE Fato_002 COMMENT 'Tabela Fato 002';
...
CREATE TABLE Fato_001 (
                ...
                PRIMARY KEY (Cod_Cliente, Cod_Produto, Cod_Fabrica, Cod_Organizacional, Cod_Tempo)
);

ALTER TABLE Fato_001 COMMENT 'Tabela Fato 001';
